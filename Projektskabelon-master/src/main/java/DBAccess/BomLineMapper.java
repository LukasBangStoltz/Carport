...
public class BomLineMapper {
    public static void insertPlanksToBomLine(Map<FlatPlankMaterial, Integer> flatPlankMatNeeded, int carportId) throws LoginSampleException {
        try {
            Connection con = Connector.connection();
            String SQL = "INSERT INTO f_styklistelinje (f_carport_id, f_materiale_id, f_længde_cm, f_antal) VALUES (?, ?, ?, ?)";
            for(Map.Entry<FlatPlankMaterial, Integer> map: flatPlankMatNeeded.entrySet()) {
